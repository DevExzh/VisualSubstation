...
// ----- 着色器 -------
import AtmosphereFragShader from '../../sky/shaders/Atmosphere.frag?raw';
import AtmosphereVertShader from '../../sky/shaders/Atmosphere.vert?raw';
import BumpedCloudLayersFragShader from '../../sky/shaders/BumpedCloudLayers.frag?raw';
import BumpedCloudLayersVertShader from '../../sky/shaders/BumpedCloudLayers.vert?raw';
import ClearAlphaFragShader from '../../sky/shaders/ClearAlpha.frag?raw';
import ClearAlphaVertShader from '../../sky/shaders/ClearAlpha.vert?raw';
...
import DensityCloudLayersFragShader from '../../sky/shaders/DensityCloudLayers.frag?raw';
import DensityCloudLayersVertShader from '../../sky/shaders/DensityCloudLayers.vert?raw';
import FastestCloudLayersFragShader from '../../sky/shaders/FastestCloudLayers.frag?raw';
import FastestCloudLayersVertShader from '../../sky/shaders/FastestCloudLayers.vert?raw';
import MoonFragShader from '../../sky/shaders/Moon.frag?raw';
import MoonVertShader from '../../sky/shaders/Moon.vert?raw';
//import ScreenClearFragShader from './shaders/ScreenClear.frag';
//import ScreenClearVertShader from './shaders/ScreenClear.vert';
import SpaceFragShader from '../../sky/shaders/Space.frag?raw';
import SpaceVertShader from '../../sky/shaders/Space.vert?raw';
import SunFragShader from '../../sky/shaders/Sun.frag?raw';
import SunVertShader from '../../sky/shaders/Sun.vert?raw';
