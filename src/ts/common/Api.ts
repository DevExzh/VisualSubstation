...
export namespace Api {
   ...
   * @see RegisterData
   */
  export async function register(data: Types.RegisterData): Promise<any> {
  ...
  export namespace Monitor {
    export namespace Cache {
      ...
      // 查询缓存名称列表
      export async function listCacheName(): Promise<any> {
        return HTTPService.get('/monitor/cache/getNames');
      }

      // 查询缓存键名列表
      export async function listCacheKey(cacheName: string): Promise<any> {
        return HTTPService.get(`/monitor/cache/getKeys/${cacheName}`);
      }

      // 查询缓存内容
      export async function getCacheValue(cacheName: string, cacheKey: string): Promise<any> {
        return HTTPService.get(`/monitor/cache/getValue/${cacheName}/${cacheKey}`);
      }

      // 清理指定名称缓存
      export async function clearCacheName(cacheName: string): Promise<any> {
        return HTTPService.delete(`/monitor/cache/clearCacheName/${cacheName}`);
      }

      // 清理指定键名缓存
      export async function clearCacheKey(cacheKey: string): Promise<any> {
        return HTTPService.delete(`/monitor/cache/clearCacheKey/${cacheKey}`);
      }

      // 清理全部缓存
      export async function clearCacheAll(): Promise<any> {
    ...
    export namespace Job {
      // 查询定时任务调度列表
      export async function listJob(query: Types.QueryOptions): Promise<any> {
      ...
      // 删除定时任务调度
      export async function delJob(jobId: string): Promise<any> {
        return HTTPService.delete(`/monitor/job/${jobId}`);
      }

      // 任务状态修改
      export async function changeJobStatus(jobId: string, status: string): Promise<any> {
        const data = {
          jobId,
          status
        };
        return HTTPService.put('/monitor/job/changeStatus', data);
      }

      // 定时任务立即执行一次
      export async function runJob(jobId: string, jobGroup: string): Promise<any> {
        const data = {
          jobId,
          jobGroup
        };
        return HTTPService.put('/monitor/job/run', data);
      }
    }

    export namespace JobLog {
      // 查询调度日志列表
      export async function listJobLog(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/monitor/jobLog/list', query);
      }

      // 删除调度日志
      export async function delJobLog(jobLogId: string): Promise<any> {
        return HTTPService.delete(`/monitor/jobLog/${jobLogId}`);
      }

      // 清空调度日志
      export async function cleanJobLog(): Promise<any> {
    ...
    export namespace LoginInfo {
      // 查询登录日志列表
      export async function list(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/monitor/logininfor/list', query);
      }

      // 删除登录日志
      export async function delLogininfor(infoId: string): Promise<any> {
        return HTTPService.delete(`/monitor/logininfor/${infoId}`);
      }

      // 解锁用户登录状态
      export async function unlockLogininfor(userName: string): Promise<any> {
        return HTTPService.get(`/monitor/logininfor/unlock/${userName}`);
      }

      // 清空登录日志
      export async function cleanLogininfor(): Promise<any> {
    ...
    export namespace Online {
      ...
      // 强退用户
      export async function forceLogout(tokenId: string): Promise<any> {
    ...
    export namespace OperationLog {
      ...
      // 删除操作日志
      export async function delOperlog(operId: string): Promise<any> {
        return HTTPService.delete(`/monitor/operlog/${operId}`);
      }

      // 清空操作日志
      export async function cleanOperlog(): Promise<any> {
  ...
  export namespace Tool {
    export namespace Gen {
      // 查询生成表数据
      export async function listTable(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/tool/gen/list', query);
      }

      // 查询db数据库列表
      export async function listDbTable(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/tool/gen/db/list', query);
      }

      // 查询表详细信息
      export async function getGenTable(tableId: string): Promise<any> {
        return HTTPService.get(`/tool/gen/${tableId}`);
      }

      // 修改代码生成信息
      export async function updateGenTable(data: any): Promise<any> {
        return HTTPService.put('/tool/gen', data);
      }

      // 导入表
      export async function importTable(data: any): Promise<any> {
      ...
      // 预览生成代码
      export async function previewTable(tableId: string): Promise<any> {
        return HTTPService.get(`/tool/gen/preview/${tableId}`);
      }

      // 删除表数据
      export async function delTable(tableId: string): Promise<any> {
        return HTTPService.delete(`/tool/gen/${tableId}`);
      }

      // 生成代码（自定义路径）
      export async function genCode(tableName: string): Promise<any> {
        return HTTPService.get(`/tool/gen/genCode/${tableName}`);
      }

      // 同步数据库
      export async function synchDb(tableName: string): Promise<any> {
  ...
  export namespace System {
    export namespace Config {
      // 查询参数列表
      export async function listConfig(query: Types.QueryOptions): Promise<any> {
      ...
      // 根据参数键名查询参数值
      export async function getConfigKey(configKey: string): Promise<any> {
        return HTTPService.get(`/system/config/configKey/${configKey}`);
      }

      // 新增参数配置
      export async function addConfig(data: any): Promise<any> {
      ...
      // 删除参数配置
      export async function delConfig(configId: string): Promise<any> {
        return HTTPService.delete(`/system/config/${configId}`);
      }

      // 刷新参数缓存
      export async function refreshCache(): Promise<any> {
    ...
    export namespace Dept {
      // 查询部门列表
      export async function listDept(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/system/dept/list', query);
      }

      // 查询部门列表（排除节点）
      export async function listDeptExcludeChild(deptId: string): Promise<any> {
        return HTTPService.get(`/system/dept/list/exclude/${deptId}`);
      }

      // 查询部门详细
      export async function getDept(deptId: string): Promise<any> {
        return HTTPService.get(`/system/dept/${deptId}`);
      }

      // 新增部门
      export async function addDept(data: any): Promise<any> {
        return HTTPService.post('/system/dept', data);
      }

      // 修改部门
      export async function updateDept(data: any): Promise<any> {
        return HTTPService.put('/system/dept', data);
      }

      // 删除部门
      export async function delDept(deptId: string): Promise<any> {
    ...
    export namespace Menu {
      // 查询菜单列表
      export async function listMenu(query: Types.QueryOptions): Promise<any> {
      ...
      // 查询菜单下拉树结构
      export async function treeselect(): Promise<any> {
        return HTTPService.get('/system/menu/treeselect');
      }

      // 根据角色ID查询菜单下拉树结构
      export async function roleMenuTreeselect(roleId: string): Promise<any> {
      ...
      // 修改菜单
      export async function updateMenu(data: any): Promise<any> {
        return HTTPService.put('/system/menu', data);
      }

      // 删除菜单
      export async function delMenu(menuId: string): Promise<any> {
    ...
    export namespace Notice {
      // 查询公告列表
      export async function listNotice(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/system/notice/list', query);
      }

      // 查询公告详细
      export async function getNotice(noticeId: number): Promise<any> {
        return HTTPService.get(`/system/notice/${noticeId}`);
      }

      // 新增公告
      export async function addNotice(data: any): Promise<any> {
        return HTTPService.post('/system/notice', data);
      }

      // 修改公告
      export async function updateNotice(data: any): Promise<any> {
        return HTTPService.put('/system/notice', data);
      }

      // 删除公告
      export async function delNotice(noticeId: number): Promise<any> {
    ...
    export namespace Post {
      // 查询岗位列表
      export async function listPost(query: Types.QueryOptions): Promise<any> {
      ...
      // 删除岗位
      export async function delPost(postId: number): Promise<any> {
    ...
    export namespace Role {
      // 查询角色列表
      export async function listRole(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/system/role/list', query);
      }

      // 查询角色详细
      export async function getRole(roleId: number): Promise<any> {
      ...
      // 修改角色
      export async function updateRole(data: any): Promise<any> {
        return HTTPService.put('/system/role', data);
      }

      // 角色数据权限
      export async function dataScope(data: any): Promise<any> {
        return HTTPService.put('/system/role/dataScope', data);
      }

      // 角色状态修改
      export async function changeRoleStatus(roleId: number, status: string): Promise<any> {
      ...
      // 删除角色
      export async function delRole(roleId: number): Promise<any> {
        return HTTPService.delete(`/system/role/${roleId}`);
      }

      // 查询角色已授权用户列表
      export async function allocatedUserList(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/system/role/authUser/allocatedList', query);
      }

      // 查询角色未授权用户列表
      export async function unallocatedUserList(query: Types.QueryOptions): Promise<any> {
        return HTTPService.get('/system/role/authUser/unallocatedList', query);
      }

      // 取消用户授权角色
      export async function authUserCancel(data: any): Promise<any> {
        return HTTPService.put('/system/role/authUser/cancel', data);
      }

      // 批量取消用户授权角色
      export async function authUserCancelAll(data: any): Promise<any> {
        return HTTPService.put('/system/role/authUser/cancelAll', data);
      }

      // 授权用户选择
      export async function authUserSelectAll(data: any): Promise<any> {
        return HTTPService.put('/system/role/authUser/selectAll', data);
      }

      // 根据角色ID查询部门树结构
      export async function deptTreeSelect(roleId: number): Promise<any> {
    ...
    export namespace User {
      // 查询用户列表
      export async function listUser(query: Types.QueryOptions): Promise<any> {
      ...
      // 删除用户
      export async function delUser(userId: number): Promise<any> {
        return HTTPService.delete('/system/user/' + userId);
      }

      // 用户密码重置
      export async function resetUserPwd(userId: number, password: string): Promise<any> {
      ...
      // 用户状态修改
      export async function changeUserStatus(userId: number, status: string): Promise<any> {
        const data = {
          userId,
          status
        };
        return HTTPService.put('/system/user/changeStatus', data);
      }
      ...
      // 用户密码重置
      export async function updateUserPwd(oldPassword: string, newPassword: string): Promise<any> {
        const data = {
          oldPassword,
          newPassword
        };
        return HTTPService.put('/system/user/profile/updatePwd', data);
      }

      // 用户头像上传
      export async function uploadAvatar(data: any): Promise<any> {
        return HTTPService.post('/system/user/profile/avatar', data);
      }

      // 查询授权角色
      export async function getAuthRole(userId: number): Promise<any> {
        return HTTPService.get('/system/user/authRole/' + userId);
      }

      // 保存授权角色
      export async function updateAuthRole(data: any): Promise<any> {
        return HTTPService.put('/system/user/authRole', data);
      }

      // 查询部门下拉树结构
      export async function deptTreeSelect(): Promise<any> {
    ...
    export namespace Dict {
      export namespace Data {
        // 查询字典数据列表
        export async function listData(query: Types.QueryOptions): Promise<any> {
          return HTTPService.get('/system/dict/data/list', query);
        }

        // 查询字典数据详细
        export async function getData(dictCode: string): Promise<any> {
        ...
        // 删除字典数据
        export async function delData(dictCode: string): Promise<any> {
