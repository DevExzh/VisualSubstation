<template>
  ...
  >
    <defs>
      ...
      <radialGradient :id="uuids[10]" cx="83.737%" cy="86.242%" r="58.353%" fx="83.737%" fy="86.242%">
      ...
      <mask :id="uuids[13]" width="28" height="14" x="0" y="0" fill="#fff" maskContentUnits="userSpaceOnUse" maskUnits="objectBoundingBox">
        <use :xlink:href="`#${uuids[12]}`" />
      </mask>
    </defs>
    <g fill="none" fill-rule="evenodd">
      <g transform="translate(16 60)">
        <use :xlink:href="`#${uuids[12]}`" :stroke="`url(#${uuids[0]})`" stroke-dasharray="12,9" stroke-width="2" :mask="`url(#${uuids[13]})`" />
        <path :fill="`url(#${uuids[1]})`" d="M8 0h12v54c0 1.657-2.686 3-6 3s-6-1.343-6-3z" />
        <ellipse cx="14" cy="54" :fill="`url(#${uuids[2]})`" rx="6" ry="3" />
        <path :fill="`url(#${uuids[3]})`" d="M14 0a1 1 0 0 1 1 1v52a1 1 0 0 1-2 0V1a1 1 0 0 1 1-1" />
      </g>
      <circle cx="30" cy="30" r="29.75" :fill="`url(#${uuids[4]})`" :stroke="`url(#${uuids[5]})`" stroke-width=".5" />
      <path
          :fill="`url(#${uuids[6]})`"
          fill-rule="nonzero"
          :stroke="`url(#${uuids[7]})`"
      ...
      <g stroke-linecap="round" stroke-linejoin="round">
        <use :xlink:href="`#${uuids[11]}`" :fill="`url(#${uuids[8]})`" />
        <circle cx="30" cy="30" r="26.5" :fill="`url(#${uuids[10]})`" :stroke="`url(#${uuids[9]})`" stroke-width=".5" />
      </g>
    </g>
  </svg>
</template>
