<template>
  ...
  >
    <defs>
      ...
      <radialGradient :id="uuids[10]" cx="50%" cy="50%" r="69.75%" fx="50%" fy="50%" gradientTransform="matrix(0 1 -1.09632 0 1.048 0)">
      ...
      <radialGradient :id="uuids[11]" cx="50%" cy="95.609%" r="34.257%" fx="50%" fy="95.609%" gradientTransform="matrix(0 1 -1.56312 0 1.994 .456)">
    ...
    <g fill="none" fill-rule="evenodd">
      ...
      <path :stroke="`url(#${uuids[1]})`" d="M6.326 8.572A29.87 29.87 0 0 0 0 27a29.87 29.87 0 0 0 6.158 18.21m47.785-.13A29.87 29.87 0 0 0 60 27c0-6.751-2.23-12.982-5.994-17.995" />
      <circle cx="30" cy="27" r="26.75" :stroke="`url(#${uuids[2]})`" stroke-width=".5" opacity=".5" />
      <g transform="translate(2.767 46)">
        <ellipse cx="26.923" cy="30" :stroke="`url(#${uuids[3]})`" stroke-width=".5" opacity=".5" rx="26.673" ry="13.75" />
        <ellipse cx="26.923" cy="28.5" :stroke="`url(#${uuids[4]})`" stroke-width=".5" rx="19.942" ry="10.25" />
        <g stroke-linejoin="bevel">
          <ellipse cx="26.923" cy="27.5" :fill="`url(#${uuids[10]})`" :stroke="`url(#${uuids[5]})`" rx="13.923" ry="7" />
          <ellipse cx="26.923" cy="27.5" :stroke="`url(#${uuids[11]})`" rx="13.923" ry="7" />
        </g>
        <path :fill="`url(#${uuids[6]})`" :stroke="`url(#${uuids[7]})`" stroke-width=".5" d="m31.992.25.99 28.717c-.004.305-.164.561-.424.799-.314.286-.772.54-1.336.756-1.152.44-2.738.709-4.489.709-1.71 0-3.263-.257-4.408-.679-.564-.208-1.027-.454-1.354-.731-.273-.232-.45-.482-.482-.753L22.467.25z" />
