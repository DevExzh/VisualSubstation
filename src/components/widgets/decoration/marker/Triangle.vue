<template>
  <div :style="{
    ...
    <div v-if="$slots.default" :style="{
            width: calculatedWidth * 0.35 + 'px',
            height: calculatedWidth * 0.35 + 'px',
         }"
         class="icon-slot"
    >
      <slot/>
    ...
    >
      <defs>
        ...
        <radialGradient :id="uuids[11]" cx="50%" cy="0%" r="31.925%" fx="50%" fy="0%"
                        gradientTransform="matrix(0 1 -.85056 0 .5 -.5)">
      ...
      <g fill="none" fill-rule="evenodd">
        ...
        <ellipse cx="39.585" cy="72.882" :fill="`url(#${uuids[1]})`" :stroke="`url(#${uuids[2]})`" rx="19.932"
                 ry="9.23"/>
        <ellipse cx="39.585" cy="66.882" :stroke="`url(#${uuids[3]})`" stroke-width=".5" rx="16.55" ry="7.75"/>
        <ellipse cx="39.585" cy="79.368" :stroke="`url(#${uuids[4]})`" :filter="`url(#${uuids[12]})`" rx="19.932"
                 ry="9.23"/>
        <path :fill="`url(#${uuids[5]})`"
              d="M39.585 57.21q-4.983 14.758-15.541 17.878c-.116.265 31.183.018 31.083 0Q44.118 71.345 39.585 57.21"/>
        <path :fill="`url(#${uuids[6]})`" d="m40 0 40 48.913-7.405 20.613H8.369L0 48.913z"
              transform="matrix(1 0 0 -1 0 69.526)"/>
        <g transform="matrix(1 0 0 -1 0 70.406)">
          <use :xlink:href="`#${uuids[13]}`" :fill="`url(#${uuids[7]})`"/>
          <path :fill="`url(#${uuids[11]})`" :stroke="`url(#${uuids[8]})`" stroke-linejoin="bevel"
                d="m40 6.727 34.488 45.208-3.98 12.068H10.314L5.523 51.92z"/>
        </g>
        <path :fill="`url(#${uuids[9]})`" fill-rule="nonzero"
              d="M9.987 5.069h60.899l4.33 13.663H72.45L69.01 7.561H11.771L7.503 18.732l-2.693-.058z"/>
        <path :stroke="`url(#${uuids[10]})`" stroke-width=".5"
              d="m5.32 18.935 2.056.045L40 62.067l32.573-43.085h2.142L40 65.068z"/>
      </g>
    </svg>
  </div>
</template>
